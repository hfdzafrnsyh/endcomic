...
$result = mysqli_query($connect , "SELECT * FROM category WHERE id='$_GET[id]'");
...
if(isset($_POST['update-category'])){
    ...
    mysqli_query($connect , "UPDATE category SET name_category='$nameCategory' WHERE id='$_GET[id]'");
    echo "
    <script>alert('Update Category Berhasil')
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Update Book</h1>
                        ...
                        <form method="POST">
                            ...
                            <input type="text" class="form-control" value="<?php echo $category['name_category']?>" required name="name-category" >
                            </div>
